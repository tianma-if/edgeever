 ...
 * - EDITOR_OUTLINE_WIDTH: Width of the left document outline (TOC) panel (default: 260px)
 * - EDITOR_CONTENT_MAX_WIDTH: Maximum width of the document editor content area (default: 800px)
 */
